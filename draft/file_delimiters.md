...
This overlay works alongside other presentation/formatting overlays. For example, numeric rendering (e.g., the character used as a decimal separator) is governed by the `decimal_separator` overlay, while the character that separates fields in exported/imported files is governed here by `file_delimiters`.
...
The file_delimiters overlay begins with the canonical ordering of OCA overlays.
1) d (digest of the overlay)
2) capture_base (capture base SAID the overlay is specific to)
3) type (community/overlays/adc/file_delimiters/1.1)
4) delimiter (string)
5) encoding (string)
...
"file_delimiters": {
  ...
  "type": "community/overlays/adc/file_delimiters/1.1",
  "delimiter": ";",
  "encoding": "UTF-8",
  "escape_char": "\"",
  "has_header": true,
...
The following is a fully canonicalized JSON oca_package with SAIDs populated for demonstrative purposes, including a minimal `capture_base` and the `file_delimiters` overlay in the ADC extensions. Values are compact and suitable for SAID calculation reproduction.
...
,"extensions":{"adc":{"EIQhXN6TmYZDHixCkPBDu9LfM9k2u9Ek_iJmpRBszqbI":{"d":"EP7b1wQe9Lk2N3vH8yR5fG6tD1cS4mV0XzAaQpLsWu3J","type":"community/adc/extension/1.0","overlays":{"file_delimiters":{"d":"EG3oB8w6wJ7wQm3m5k5tGzj5n2mK3D0tq8qg3lH8s9cY","type":"community/overlays/adc/file_delimiters/1.1","delimiter":";","encoding":"UTF-8","escape_char":"\\\"","has_header":true,"line_terminator":"\n","quote_char":"\\\""}}}}}}
```
